(function(){
  ...
  function mainCtrl(loginService,$cookies,couponService,$scope){
    ...
    function displayPlaceInfo (place) {
      ...
      content += '<span class="tel">'+place.phone+'</span> <button type="button" onclick="$.post(\'/send\',{data:\''+place.title+'\'},function(data){$(\'#img\').attr(\'src\',data.co_image) console.log(data.co_image)});" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#myModal">쿠폰 발급</button> '+'</div>'
