(function(){
  ...
  function mainCtrl(loginService,$cookies,couponService,$scope){
    ...
    function displayPlaceInfo (place) {
      ...
      content += '<span class="tel">'+place.phone+'</span> <button type="button" onclick="$.post(\'/send\',{data:\''+place.title+'\'},function(data){$(\'#img\').attr(\'src\',data.co_image); $(\'#img\').attr(\'co_name\',data.co_name); $(\'#img\').attr(\'co_date\',data.co_date); $(\'#img\').attr(\'co_content\',data.co_content); console.log(data)});" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#myModal">쿠폰 발급</button> '+'</div>'
